...
flags.DEFINE_float("init_lr", 0.003, "Initial learning rate [0.001]")
...
flags.DEFINE_float("var_decay", 0.9999, "Exponential moving average decay for variables [0.999]")
...
flags.DEFINE_float("decay", 0.999, "Exponential moving average decay for logging values [0.9]")
